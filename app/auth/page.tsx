...
const SignIn = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-[80vh] bg-white'>
      ...
      <h1 className="text-black font-bold text-3xl">{isSignUp ? 'Créer un compte' : 'Se connecter'}</h1>
      <form onSubmit={handleFormSubmit} className="flex flex-col mt-8">
        ...
        <input
          ...
          className="border mb-4 p-2 text-black"
        />
        <button type="submit" className="border border-gray-600 font-medium text-xl text-black p-2">
          {isSignUp ? 'Créer un compte' : 'Se connecter'}
        </button>
      </form>
      <button onClick={handleSignIn} className="border mt-8 border-gray-600 font-medium text-xl text-black p-2">
